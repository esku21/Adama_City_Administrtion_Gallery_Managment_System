            ...
            >
                <form @submit.prevent="submitSecurity" class="space-y-6">
                    <div class="space-y-2">
                        ...
                        >
                            {{ t("admin_settings.current_password") }}
                        </label>
                        <input
                            v-model="securityForm.current_password"
                            type="password"
                            class="w-full px-5 py-4 rounded-2xl border-slate-100 bg-slate-50 focus:ring-indigo-500 font-bold outline-none"
                        />
                        <p
                    ...
                    <div class="space-y-2">
                        <label
                            class="text-[10px] font-black uppercase text-slate-400 tracking-widest ml-1"
                        >
                            {{ t("admin_settings.confirm_password") }}
                        </label>
                        <input
                    ...
                    <button
                        ...
                        class="w-full bg-indigo-600 text-white py-4 rounded-2xl font-black uppercase text-[10px] tracking-widest shadow-lg hover:bg-indigo-700 transition-all disabled:opacity-50"
                    >
                        {{
                            securityForm.processing
                                ? t("admin_settings.updating_btn")
                                : t("admin_settings.update_btn")
                        }}
                    </button>
                </form>
            </div>
